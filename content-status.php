  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="entry-header">
      <header>
        ...
        <h2><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'winterlude-theme' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php echo get_the_date(); ?></a></h2>
      </header>
      <?php echo get_avatar( get_the_author_meta( 'ID' ), apply_filters( 'winterlude-theme_status_avatar', '48' ) ); ?>
    </div><!-- .entry-header -->
